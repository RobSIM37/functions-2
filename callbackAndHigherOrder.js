...
each(names, (item) => console.log(`${item.toUpperCase()}`));
...
// // CODE HERE
console.log(addTen(4), addTen(67));
...
// // CODE HERE
const addFavoriteNumber = addingFactory(25);
console.log(addFavoriteNumber(5), addFavoriteNumber(addFavoriteNumber(0)));